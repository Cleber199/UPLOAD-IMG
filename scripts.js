...
const elements = {
  ...
  closeButton: document.getElementById(".close"), // Botão para fechar o Modal
  uploadForm: document.querySelector("uploadForm"),// Formulário de upload
...
function renderPhotoGrid(photos) {
  ...
  // Para cada foto no Array, criar um Card e adiciona o Grid
...
async function uploadNewPhoto(formdata) {
  try {
    ...
    shadowNotification("Foto enviada com sucesso!");
...
function openUploadModal() {
  // Abre o model de Upload (Mostra a janela de adicionar fato)
  elements.uploadModal.style.display = "block"; // Muda o CSS para block (visível)
}
...
function handleOutsideClick(event) {
  ...
  function handleFormSubmit(event) {
    ...
    formData.append("name", elements.fileInput.value); // Adiciona o nome da foto
  ...
  async function loadAndDisplayPhotos() {
    ...
    renderPhotosGrid(photos); // Renderiza as fotos no Grid
  }
  ...
  function setupEventListeners() {
    ...
    // Submit do formulário chama a funçãode upload
